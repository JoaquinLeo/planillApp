export default function ConfirmDeleteRelacion({ open, usuarioRelacion, onConfirm, onCancel }) {
  if (!open) return null;
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div className="bg-white border-2 border-black rounded-lg p-3 w-9/12 sm:w-1/3 shadow-lg">
        ...
        <p className="p-2 text-center">
          ¿Seguro que querés eliminar la relacion con <strong>{usuarioRelacion}</strong>?
        </p>
